...
@dataclass
class ClassificationDataTransformationConfig:
    preprocessor_obj_file_path: str = os.path.join('artifact', "classification", "preprocessor.pkl.gz")
...
class ClassificationDataTransformation:
    def __init__(self):
        self.data_transformation_config = ClassificationDataTransformationConfig()
    ...
    def get_data_transformer_object(self):
        try:
            ...
            numeric_columns = ['quantity tons', 'country', 'application', 'thickness', 'width',
                               ...
                               'delivery_day', 'delivery_month', 'delivery_year','selling_price']
            
            discrete_categorical_columns = ['item type']
    ...
    def initiate_data_transformer(self, train_path, test_path):
        try:
            ...
            train_df[target_column_name] = train_df[target_column_name]
            test_df[target_column_name] = test_df[target_column_name]
